...
FREEBSD="https://github.com/mcmilk/openzfs-freebsd-images/releases/download/v2024-08-06"
URLzs=""
...
case "$OS" in
  ...
  freebsd13r)
    ...
    ;;
  freebsd13p)
    OSNAME="FreeBSD 13.4 (Prerelease)"
    OSv="freebsd13.0"
    URLzs="$FREEBSD/amd64-freebsd-13.4-PRERELEASE.qcow2.zst"
    BASH="/usr/local/bin/bash"
    ;;
  freebsd14r)
