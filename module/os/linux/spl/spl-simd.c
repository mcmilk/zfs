...
extern void kernel_neon_begin(void);
extern void kernel_neon_end(void);
...
/* ARM */
extern boolean_t zfs_neon_available(void);
extern boolean_t zfs_sha256_available(void);
extern boolean_t zfs_sha512_available(void);
...
#define spl_kfpu_allowed 0
#define spl_kfpu_cpu_has 0
#define spl_kfpu_begin
#define spl_kfpu_end
